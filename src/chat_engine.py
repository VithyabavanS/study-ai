...
#             use_openai: If True, use OpenAI GPT. If False, use simple template
#         """
...
#             )
#         else:
#             # We'll use a simple template-based approach (free)
#             self.llm = None
...
#                 }
#             else:
#                 # Simple template-based approach (FREE!)
#                 # Just return the most relevant chunks
#                 context = "\n\n".join([doc.page_content for doc in relevant_docs])
                
#                 answer = f"""Based on the document, here are the most relevant passages:

# {context}

# 💡 Note: Using free mode - showing relevant text excerpts. 
# For AI-generated answers, add an OpenAI API key."""
